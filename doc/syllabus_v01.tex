...
\item Programming: 
\begin{itemize}
 \item We will use Python 3.7 with Colab cloud computing platform for implementation. Although we will introduce minimal basic python concepts on in class, it is student's responsibility to master enough coding skills  through online resources to accomplish 
