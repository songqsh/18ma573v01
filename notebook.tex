...
\makeatother
    ...
    \section{Python basics on Jupyter notebook
(Colab)}\label{python-basics-on-jupyter-notebook-colab}

\begin{itemize}
\tightlist
\item
  \href{./src/python_notebook.ipynb}{Python on notebook}
\item
  \href{./src/pandas_basics.ipynb}{Pandas}
\end{itemize}
...
\end{itemize}
    ...
    \section{Finite difference method}\label{finite-difference-method}

\begin{itemize}
\tightlist
\item
  \href{./src/ftcs_stability_heat_1d.ipynb}{FTCS and stability: Heat
  equation}
\item
  \href{./src/btcs_stability_heat_1d.ipynb}{BTCS and stability: Heat
  equation}
\end{itemize}
