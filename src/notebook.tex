...
\[\bar \alpha_N = \frac 1 N \sum_{i=1}^N \alpha_i\] as its estimator of
the mean \(\mathbb E[\alpha_1]\) and
\[\beta_N = \frac 1 N \sum_{i=1}^N (\alpha_i -\bar \alpha_N)^2\] as the
estimator of \(Var(\alpha_1)\).
